...
import { Box, InputLabel, useTheme, FormHelperText } from '@mui/material';
import CalendarTodayIcon from '@mui/icons-material/CalendarToday';
import { NepaliDateConverter, NepaliDatePicker } from 'react-nepali-date-picker-lite';

const NepaliDatePickerWithDefault = ({ formName, fieldName, value, handleDateChange, error }) => {
    ...
    return (
        ...
        >
            ...
            {error && <FormHelperText sx={{ color: theme.palette.error.main }}>The date field is required.</FormHelperText>}
        </Box>
    );
};

export default NepaliDatePickerWithDefault;
